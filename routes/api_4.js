...
const paySchema=require('../models/pay2')
...
router.get('/:userID',function(req,res){
    ...
    .then(user=>{
            ...
            apimodel.findByIdAndUpdate(user[0]._id,{$set:{api3:user[0].api3+1}},{new:true})
            .then((data)=>
            {
                console.log("Updated")
            })
...
router.post('/:userID',(req,res)=>
{
    ...
    .exec()
   .then(users=>{
    apimodel.findByIdAndUpdate(users[0]._id,{$set:{api3:users[0].api3+1}},{new:true})
    .then((data)=>
    {
        console.log("Updated")
    })
