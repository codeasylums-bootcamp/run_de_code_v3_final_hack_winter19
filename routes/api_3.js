...
const paySchema=require('../models/pay1')
...
router.get('/:userID',function(req,res){
    ...
    .then(user=>{
            ...
            apimodel.findByIdAndUpdate(user[0]._id,{$set:{api2:user[0].api2+1}},{new:true})
            .then((data)=>
            {
                console.log("Updated")
            })
...
router.post('/:userID',(req,res)=>
{
    ...
    .exec()
   .then(users=>{
    apimodel.findByIdAndUpdate(users[0]._id,{$set:{api2:users[0].api2+1}},{new:true})
    .then((data)=>
    {
        console.log("Updated")
    })
