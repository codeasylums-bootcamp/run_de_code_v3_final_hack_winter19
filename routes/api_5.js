...
const paySchema=require('../models/pay3')
...
router.get('/:userID',function(req,res){
    ...
    .then(user=>{
            ...
            apimodel.findByIdAndUpdate(user[0]._id,{$set:{api4:user[0].api4+1}},{new:true})
            .then((data)=>
            {
                console.log("Updated")
            })
...
router.post('/:userID',(req,res)=>
{
    ...
    .exec()
   .then(users=>{
    apimodel.findByIdAndUpdate(users[0]._id,{$set:{api4:users[0].api4+1}},{new:true})
    .then((data)=>
    {
        console.log("Updated")
    })
