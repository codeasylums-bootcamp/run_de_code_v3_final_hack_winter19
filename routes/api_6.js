...
const paySchema=require('../models/pay4')
...
router.get('/:userID',function(req,res){
    ...
    .then(user=>{
            ...
            apimodel.findByIdAndUpdate(user[0]._id,{$set:{api5:user[0].api5+1}},{new:true})
            .then((data)=>
            {
                console.log("Updated")
            })
...
router.post('/:userID',(req,res)=>
{
    ...
    .exec()
   .then(users=>{
    apimodel.findByIdAndUpdate(users[0]._id,{$set:{api5:users[0].api5+1}},{new:true})
    .then((data)=>
    {
        console.log("Updated")
    })
