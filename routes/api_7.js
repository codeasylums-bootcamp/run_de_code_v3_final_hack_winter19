...
const paySchema=require('../models/pay5')
...
router.get('/:userID',function(req,res){
    ...
    .then(user=>{
            ...
            apimodel.findByIdAndUpdate(user[0]._id,{$set:{api6:user[0].api6+1}},{new:true})
            .then((data)=>
            {
                console.log("Updated")
            })
...
router.post('/:userID',(req,res)=>
{
    ...
    .exec()
   .then(users=>{
    apimodel.findByIdAndUpdate(users[0]._id,{$set:{api6:users[0].api6+1}},{new:true})
    .then((data)=>
    {
        console.log("Updated")
    })
